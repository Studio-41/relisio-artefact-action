...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.upload = exports.post = exports.optionFactory = void 0;
...
const optionFactory = (urlObject, apiKey, headers) => ({
    hostname: urlObject.hostname,
    path: urlObject.pathname,
    port: urlObject.port,
    method: 'POST',
    headers: Object.assign({ Authorization: `Bearer ${apiKey}` }, headers)
});
...
exports.post = post;
const upload = (url, apiKey, path) => __awaiter(void 0, void 0, void 0, function* () {
    return new Promise((resolve, reject) => {
